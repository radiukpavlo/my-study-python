"""Writes the LaTeX Results section referencing generated assets."""
...
RESULTS_TEX = ROOT / "results_section.tex"
...
\input{tables/tab_macro_seg.tex}
...
\input{tables/tab_per_structure_acdc.tex}
\input{tables/tab_per_structure_mms.tex}
...
\input{tables/tab_domain_gap.tex}
...
\input{tables/tab_cls_macro.tex}
\input{tables/tab_cls_per_class.tex}
...
def main() -> None:
    RESULTS_TEX.write_text(textwrap.dedent(CONTENT).strip() + "\n")
    print(f"Wrote {RESULTS_TEX.relative_to(ROOT)}")
